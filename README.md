...
FlexFile lets you convert images, audio, and video files between formats without ever sending your files anywhere. Every conversion happens locally on your device using FFmpeg compiled to WebAssembly.
...
```bash
git clone https://github.com/ambrishkd/flexfile.git
cd flexfile
npm install
npm run dev
```
